...
Path letterL() {
  ...
  path_1.quadraticBezierTo(size.width * 0.1322811, size.height * 0.6990613,
      size.width * 0.1332667, size.height * 0.4708990);
  ...
  path_1.arcToPoint(Offset(size.width * 0.1943459, size.height * 0.5925856),
      ...
      largeArc: false,
      clockwise: false);
  path_1.quadraticBezierTo(size.width * 0.2005262, size.height * 0.5939130,
      size.width * 0.2065746, size.height * 0.5939130);
...
Path letterU() {
  ...
  path_2.quadraticBezierTo(size.width * 0.3166334, size.height * 0.1858484,
      size.width * 0.3140697, size.height * 0.2906717);
  path_2.arcToPoint(Offset(size.width * 0.3115060, size.height * 0.5013206),
      ...
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3115060, size.height * 0.5125628,
      size.width * 0.3117025, size.height * 0.5347221);
  path_2.quadraticBezierTo(size.width * 0.3118964, size.height * 0.5565293,
      size.width * 0.3124108, size.height * 0.5834564);
  path_2.arcToPoint(Offset(size.width * 0.3124270, size.height * 0.5843232),
      ...
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3129521, size.height * 0.6117650,
      size.width * 0.3139377, size.height * 0.6405342);
  path_2.arcToPoint(Offset(size.width * 0.3153650, size.height * 0.6729469),
      radius:
          Radius.elliptical(size.width * 0.06723255, size.height * 0.3381598),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.arcToPoint(Offset(size.width * 0.3166334, size.height * 0.6931152),
      radius:
          Radius.elliptical(size.width * 0.05427670, size.height * 0.2729957),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.arcToPoint(Offset(size.width * 0.3182061, size.height * 0.7116716),
      radius:
          Radius.elliptical(size.width * 0.03384518, size.height * 0.1702312),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3193694, size.height * 0.7233472,
      size.width * 0.3207751, size.height * 0.7321378);
  path_2.arcToPoint(Offset(size.width * 0.3225498, size.height * 0.7407929),
      radius:
          Radius.elliptical(size.width * 0.009379595, size.height * 0.04717658),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.arcToPoint(Offset(size.width * 0.3264950, size.height * 0.7473486),
      radius:
          Radius.elliptical(size.width * 0.006554675, size.height * 0.03296807),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.arcToPoint(Offset(size.width * 0.3313639, size.height * 0.7387612),
      radius:
          Radius.elliptical(size.width * 0.007885000, size.height * 0.03965921),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.arcToPoint(Offset(size.width * 0.3333324, size.height * 0.7291579),
      radius:
          Radius.elliptical(size.width * 0.01223683, size.height * 0.06154763),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.arcToPoint(Offset(size.width * 0.3357992, size.height * 0.7112652),
      radius:
          Radius.elliptical(size.width * 0.02562894, size.height * 0.1289060),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3368629, size.height * 0.7020818,
      size.width * 0.3378162, size.height * 0.6910022);
  path_2.arcToPoint(Offset(size.width * 0.3386591, size.height * 0.6805456),
      radius:
          Radius.elliptical(size.width * 0.04998680, size.height * 0.2514188),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3408862, size.height * 0.6510856,
      size.width * 0.3425612, size.height * 0.6129299);
  path_2.arcToPoint(Offset(size.width * 0.3426689, size.height * 0.6104376),
      radius:
          Radius.elliptical(size.width * 0.1332963, size.height * 0.6704412),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  ...
  path_2.arcToPoint(Offset(size.width * 0.3489920, size.height * 0.3310081),
      ...
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3491267, size.height * 0.3169757,
      size.width * 0.3491994, size.height * 0.3044603);
  ...
  path_2.arcToPoint(Offset(size.width * 0.3493017, size.height * 0.2829782),
      ...
      largeArc: false,
      clockwise: false);
  path_2.quadraticBezierTo(size.width * 0.3493744, size.height * 0.2646115,
      size.width * 0.3493744, size.height * 0.2542226);
  path_2.arcToPoint(Offset(size.width * 0.3493744, size.height * 0.2539652),
      radius:
          Radius.elliptical(size.width * 0.1143944, size.height * 0.5753701),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  ...
  path_2.arcToPoint(Offset(size.width * 0.4102570, size.height * 0.3419253),
      ...
      largeArc: false,
      clockwise: true);
  path_2.quadraticBezierTo(size.width * 0.4093360, size.height * 0.4007910,
      size.width * 0.4072328, size.height * 0.4636254);
  path_2.quadraticBezierTo(size.width * 0.4051269, size.height * 0.5264462,
      size.width * 0.4017741, size.height * 0.5909331);
  path_2.arcToPoint(Offset(size.width * 0.3934259, size.height * 0.7149359),
      radius:
          Radius.elliptical(size.width * 0.1810911, size.height * 0.9108345),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.quadraticBezierTo(size.width * 0.3884278, size.height * 0.7744653,
      size.width * 0.3817869, size.height * 0.8263826);
  path_2.arcToPoint(Offset(size.width * 0.3681982, size.height * 0.9093039),
      radius:
          Radius.elliptical(size.width * 0.08805455, size.height * 0.4428883),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.arcToPoint(Offset(size.width * 0.3665340, size.height * 0.9169838),
      radius:
          Radius.elliptical(size.width * 0.08174493, size.height * 0.4111528),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.arcToPoint(Offset(size.width * 0.3472712, size.height * 0.9778407),
      radius:
          Radius.elliptical(size.width * 0.06737258, size.height * 0.3388641),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.quadraticBezierTo(size.width * 0.3366205, size.height * 0.9999865,
      size.width * 0.3236028, size.height * 0.9999865);
  path_2.arcToPoint(Offset(size.width * 0.3110239, size.height * 0.9952458),
      radius:
          Radius.elliptical(size.width * 0.07973329, size.height * 0.4010348),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.quadraticBezierTo(size.width * 0.3039064, size.height * 0.9895163,
      size.width * 0.2979038, size.height * 0.9769061);
  path_2.arcToPoint(Offset(size.width * 0.2971067, size.height * 0.9751859),
      radius:
          Radius.elliptical(size.width * 0.04956132, size.height * 0.2492787),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.arcToPoint(Offset(size.width * 0.2800306, size.height * 0.9192458),
      radius:
          Radius.elliptical(size.width * 0.06015274, size.height * 0.3025505),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.arcToPoint(Offset(size.width * 0.2778439, size.height * 0.9083964),
      radius:
          Radius.elliptical(size.width * 0.05698851, size.height * 0.2866353),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.arcToPoint(Offset(size.width * 0.2650173, size.height * 0.8139891),
      radius:
          Radius.elliptical(size.width * 0.07021905, size.height * 0.3531810),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.arcToPoint(Offset(size.width * 0.2646942, size.height * 0.8105081),
      radius:
          Radius.elliptical(size.width * 0.07878537, size.height * 0.3962670),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_2.quadraticBezierTo(size.width * 0.2595668, size.height * 0.7546222,
      size.width * 0.2566745, size.height * 0.6921264);
  path_2.arcToPoint(Offset(size.width * 0.2526620, size.height * 0.5644801),
      radius:
          Radius.elliptical(size.width * 0.1800489, size.height * 0.9055927),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  ...
  path_2.arcToPoint(Offset(size.width * 0.2515444, size.height * 0.4391499),
      ...
      largeArc: false,
      clockwise: true);
  path_2.quadraticBezierTo(size.width * 0.2515444, size.height * 0.3465576,
      size.width * 0.2533864, size.height * 0.2543039);
  path_2.quadraticBezierTo(size.width * 0.2552257, size.height * 0.1620366,
      size.width * 0.2586458, size.height * 0.07010795);
  path_2.close();
  return path_2;
}
...
Path letterR() {
  ...
  path_6.quadraticBezierTo(size.width * 0.8454966, size.height * 0.8081919,
      size.width * 0.8460890, size.height * 0.6587249);
  ...
  path_6.arcToPoint(Offset(size.width * 0.8479956, size.height * 0.2076691),
      ...
      largeArc: false,
      clockwise: true);
  path_6.quadraticBezierTo(size.width * 0.8482568, size.height * 0.1329423,
      size.width * 0.8490459, size.height * 0.05687467);
  path_6.arcToPoint(Offset(size.width * 0.8649532, size.height * 0.03134270),
      radius:
          Radius.elliptical(size.width * 0.1738874, size.height * 0.8746021),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.8671911, size.height * 0.02844411),
      radius:
          Radius.elliptical(size.width * 0.1584325, size.height * 0.7968684),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.8851424, size.height * 0.01091712),
      radius:
          Radius.elliptical(size.width * 0.1705697, size.height * 0.8579149),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.quadraticBezierTo(size.width * 0.8941476, size.height * 0.004632326,
      size.width * 0.9034195, size.height * 0.002316163);
  path_6.quadraticBezierTo(
      size.width * 0.9126887, 0, size.width * 0.9224184, 0);
  path_6.arcToPoint(Offset(size.width * 0.9514135, size.height * 0.02083192),
      radius:
          Radius.elliptical(size.width * 0.1016863, size.height * 0.5114521),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9711476, size.height * 0.06552981),
      radius:
          Radius.elliptical(size.width * 0.07713727, size.height * 0.3879776),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9761996, size.height * 0.08332769),
      radius:
          Radius.elliptical(size.width * 0.07076033, size.height * 0.3559035),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9934911, size.height * 0.1871622),
      radius:
          Radius.elliptical(size.width * 0.06225595, size.height * 0.3131290),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9991948, size.height * 0.2764090),
      radius:
          Radius.elliptical(size.width * 0.05585747, size.height * 0.2809465),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width, size.height * 0.3320105),
      radius:
          Radius.elliptical(size.width * 0.07327556, size.height * 0.3685544),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9995557, size.height * 0.3811917),
      radius:
          Radius.elliptical(size.width * 0.1030705, size.height * 0.5184142),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9982253, size.height * 0.4255916),
      radius:
          Radius.elliptical(size.width * 0.07815252, size.height * 0.3930840),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9940082, size.height * 0.4891167),
      radius:
          Radius.elliptical(size.width * 0.05709084, size.height * 0.2871500),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9926374, size.height * 0.5026480),
      radius:
          Radius.elliptical(size.width * 0.05200922, size.height * 0.2615910),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9836133, size.height * 0.5632475),
      radius:
          Radius.elliptical(size.width * 0.05441673, size.height * 0.2737000),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9827731, size.height * 0.5674599),
      radius:
          Radius.elliptical(size.width * 0.06119762, size.height * 0.3078059),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9751789, size.height * 0.6001029),
      radius:
          Radius.elliptical(size.width * 0.07800441, size.height * 0.3923391),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.arcToPoint(Offset(size.width * 0.9681772, size.height * 0.6243346),
      radius:
          Radius.elliptical(size.width * 0.1019960, size.height * 0.5130098),
      rotation: 0,
      largeArc: false,
      clockwise: true);
  path_6.close();
  ...
  path_6.arcToPoint(Offset(size.width * 0.9190737, size.height * 0.4726463),
      radius:
          Radius.elliptical(size.width * 0.04745273, size.height * 0.2386732),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9199866, size.height * 0.4715627),
      radius:
          Radius.elliptical(size.width * 0.05299754, size.height * 0.2665619),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9280198, size.height * 0.4563925),
      radius:
          Radius.elliptical(size.width * 0.03542595, size.height * 0.1781820),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9305054, size.height * 0.4490647),
      radius:
          Radius.elliptical(size.width * 0.03185508, size.height * 0.1602216),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9381318, size.height * 0.4100557),
      radius:
          Radius.elliptical(size.width * 0.02478066, size.height * 0.1246394),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9407413, size.height * 0.3748121),
      radius:
          Radius.elliptical(size.width * 0.01917660, size.height * 0.09645261),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9410914, size.height * 0.3531675),
      radius:
          Radius.elliptical(size.width * 0.02548621, size.height * 0.1281881),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9405717, size.height * 0.3222040),
      radius:
          Radius.elliptical(size.width * 0.03513780, size.height * 0.1767327),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9395780, size.height * 0.3022525),
      radius:
          Radius.elliptical(size.width * 0.02891167, size.height * 0.1454171),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9367369, size.height * 0.2728061),
      radius:
          Radius.elliptical(size.width * 0.02329683, size.height * 0.1171762),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9351076, size.height * 0.2622276),
      radius:
          Radius.elliptical(size.width * 0.02103205, size.height * 0.1057850),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9285583, size.height * 0.2376437),
      radius:
          Radius.elliptical(size.width * 0.02029687, size.height * 0.1020873),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9277451, size.height * 0.2357746),
      radius:
          Radius.elliptical(size.width * 0.02371155, size.height * 0.1192621),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9224749, size.height * 0.2281624),
      radius:
          Radius.elliptical(size.width * 0.02241085, size.height * 0.1127199),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.arcToPoint(Offset(size.width * 0.9174229, size.height * 0.2261848),
      radius:
          Radius.elliptical(size.width * 0.03101487, size.height * 0.1559956),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.quadraticBezierTo(size.width * 0.9147919, size.height * 0.2261848,
      size.width * 0.9122955, size.height * 0.2278373);
  path_6.arcToPoint(Offset(size.width * 0.9074294, size.height * 0.2328082),
      radius:
          Radius.elliptical(size.width * 0.03541787, size.height * 0.1781414),
      rotation: 0,
      largeArc: false,
      clockwise: false);
  path_6.close();
